    ...
    public class Burger
    {
        ...
        public void Update(GameTime gameTime, KeyboardState keyBoard)
        {
            ...
            if (health > 0)
            {
                ...
                if (keyBoard.IsKeyDown(Keys.W)) drawRectangle.Y -= GameConstants.BurgerMovementAmount;
                if (keyBoard.IsKeyDown(Keys.S)) drawRectangle.Y += GameConstants.BurgerMovementAmount;
                if (keyBoard.IsKeyDown(Keys.A)) drawRectangle.X -= GameConstants.BurgerMovementAmount;
                if (keyBoard.IsKeyDown(Keys.D)) drawRectangle.X += GameConstants.BurgerMovementAmount;
